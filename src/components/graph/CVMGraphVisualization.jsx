...
import { Building2, X, Network } from 'lucide-react';
      ...
      <div className="w-full h-full max-w-7xl max-h-[90vh] flex flex-col">
        <Card className="bg-slate-900 border-white/10 flex-1 flex flex-col">
          ...
          <CardContent className="flex-1 flex gap-4 p-4 min-h-0">
            ...
            <div className="flex-1 bg-slate-950 rounded-lg border border-white/10 relative overflow-hidden flex items-center justify-center">
              <div className="text-center text-slate-400">
                <Network className="w-16 h-16 mx-auto mb-4 opacity-50" />
                <p className="text-lg mb-2">Graph visualization requires vis-network library</p>
                <p className="text-sm">Install vis-network to enable interactive graph visualization</p>
              </div>
            </div>
          </CardContent>
        </Card>
