          ...
          {metricsData.map((metric, idx) => {
            ...
            return (
              <AnimatePresence key={idx} mode="wait">
                ...
                >
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-all h-full flex flex-col">
                    <div className={`w-10 h-10 rounded-lg bg-gradient-to-r ${metric.color} flex items-center justify-center mb-3 flex-shrink-0`}>
